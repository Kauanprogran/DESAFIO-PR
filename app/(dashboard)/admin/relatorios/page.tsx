      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          >
            ...
            {[
              { cidade: "Curitiba", agendamentos: 1234 },
              { cidade: "São José dos Pinhais", agendamentos: 456 },
              { cidade: "Capitão Leônidas", agendamentos: 234 },
              { cidade: "Londrina", agendamentos: 189 },
              { cidade: "Maringá", agendamentos: 156 },
            ].map((c) => {
              const max = 1234;
              return (
                <div key={c.cidade} className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1 h-4 rounded-full overflow-hidden bg-white/5">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${(c.agendamentos / max) * 100}%` }}
