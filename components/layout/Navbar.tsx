      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex-shrink-0">
            <span className="flex items-center justify-center" style={{ background: 'rgba(15, 10, 46, 0.9)', borderRadius: '14px', width: 80, height: 80, overflow: 'hidden' }}>
              <Image src="/logo.png" alt="Help Pet" width={108} height={135} priority style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </span>
          </Link>
